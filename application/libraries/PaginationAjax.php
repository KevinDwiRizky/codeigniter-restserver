...
class PaginationAjax{
    ...
    var $next_link       = '<li>&#187;';
    var $prev_link       = '<li>&#171;';
    var $last_link       = '<li>Last';
    var $uri_segment     = 4;
    var $full_tag_open   = '<div class="kt-pagination  kt-pagination--brand"><ul class="kt-pagination__links">';
    var $full_tag_close  = '</ul>';
    var $first_tag_open  = '<li><a>';
    var $first_tag_close = '&nbsp;</li>';
    var $last_tag_open   = '<li>&nbsp;';
    var $last_tag_close  = '</li>';
    var $cur_tag_open    = '&nbsp;<li class="kt-pagination__link--active"><a href="#">';
    ...
    function create_links(){
        ...
        if ($this->show_count){
            ...
            $info = '<div class="kt-pagination__toolbar"><span class="pagination__desc">Menampilkan ' . ( $curr_offset + 1 ) . ' Sampai ' ;
            ...
            $info .= ' Dari ' . $this->total_rows . ' </span></div></div> ';
            $output .= $info;
        }
